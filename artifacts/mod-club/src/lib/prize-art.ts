...
const COINS = svgData(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 360"><defs><linearGradient id="g" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#78350f"/><stop offset="1" stop-color="#111827"/></linearGradient></defs><rect width="640" height="360" fill="url(#g)"/><circle cx="250" cy="188" r="78" fill="#f59e0b"/><circle cx="250" cy="188" r="58" fill="#fbbf24"/><circle cx="370" cy="168" r="70" fill="#eab308"/><circle cx="370" cy="168" r="52" fill="#facc15"/><text x="250" y="198" text-anchor="middle" font-size="42" font-family="Arial Black,sans-serif" fill="#92400e">¢</text><text x="370" y="178" text-anchor="middle" font-size="36" font-family="Arial Black,sans-serif" fill="#92400e">¢</text><text x="320" y="312" text-anchor="middle" font-family="Arial Black,sans-serif" font-size="36" fill="#fde68a">COİN</text></svg>`);
...
export const PRIZE_TEMPLATES = [
  ...
  { id: 'coins', title: 'Coin Çekilişi', prizeText: 'Coin ödülü', coins: 0, image: COINS },
] as const;
